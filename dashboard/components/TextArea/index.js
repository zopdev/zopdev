        ...
        className={`
          ${
            error
              ...
              : 'px-4 block w-full rounded-md border-0 bg-transparent py-1.5 text-gray-600 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-primary-500 sm:text-sm sm:leading-6 '
          }
